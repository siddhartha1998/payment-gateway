...
- Create Angular project with ng: `ng new paymentgateway.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`paymentgateway.client.esproj`).
